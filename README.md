...
Analyzes keywords and recommends the most cost-effective model.

### 3. **Phased Calibration (Training Module)**
Learns your preferences over time.

### 4. **One-Click Enhancement**
Simply click the ✨ button in any textarea.
...
1. Navigate to any website with textarea elements
2. Click in a textarea
3. Type your prompt
4. Click ✨ to enhance
5. Click **Replace Text** to update

## 🔧 Technical Stack

- **Manifest V3** - Latest Chrome Extension standard
- **Vanilla JavaScript (ES6+)** - No frameworks
- **Chrome Storage API** - Persistent tracking
